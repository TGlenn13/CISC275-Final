...
import {detailedQuestions, DetailedQuestion} from '../quiz-components/DetailedQuestions';
...
//generated by chatgpt
  function markComplete(question: DetailedQuestion): void {
  ...
  function markUncomplete(question: DetailedQuestion): void {
    if (completedQuestions[question.name]) {
...
//end gpt
  ...
  const handleChange= (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, question:DetailedQuestion) => {
