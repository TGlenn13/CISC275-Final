...
//end gpt
  ...
  const detailedQuestions = [
    unformattedDetailedQuestions.slice(0, 4).map((question, index) => ({
        ...question,
        selectedAnswer: "",
        onAnswerChange: (answer: string) => handleChange(index, answer)
    })),
    unformattedDetailedQuestions.slice(4, 8).map((question, index) => ({
        ...question,
        selectedAnswer: "",
        onAnswerChange: (answer: string) => handleChange(index + 4, answer)
    }))
];
